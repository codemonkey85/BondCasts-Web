...
public sealed partial class PageRenderer
{
    ...
    public string RenderFallback(string kind, string? feedUrl, string originalUrl, string? openUrl = null)
    {
        ...
        body.Append($"<p class=\"lede\">If you have {SiteName} installed, this link opens the {kind} right in the app. Otherwise, get {SiteName} for iPhone, iPad, Mac, and Apple Watch in the US and Canada.</p>");
    ...
    public string RenderOpaqueFallback(string kind, string? id, string originalUrl, string? openUrl = null)
    {
        ...
        var body = new StringBuilder();
        body.Append($"<p class=\"lede\">If you have {SiteName} installed, this shared {HtmlEncode(kind)} opens right in the app. Otherwise, get {SiteName} for iPhone, iPad, Mac, and Apple Watch in the US and Canada.</p>");
